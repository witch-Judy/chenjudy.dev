export const zh = {
  ...
  // About
  aboutTitle: "关于我",
  aboutBio: `IRIS 创始人，用 AI 把复杂文本变成可交互的立体文章——不只是读，而是上手玩。哈工大 CS + NUS 硕士，全栈 builder。写代码、做产品、做增长、建个人 IP、练剑。信仰好玩儿主义。`,
...
作为 IRIS 的创始人，我正为 6000 多名用户打造 AI 阅读伙伴。同时，我也在工业领域担任技术布道者，让复杂的 AI 在工业物联网（IIoT）中真正"落地"。我曾用两周自学摄影并在一个月内实现商业闭环——这种极速学习并交付价值的能力，贯穿我所有的项目。
